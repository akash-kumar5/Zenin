    ...
    <ScrollView style={styles.container}>
      ...
      >
        <View style={styles.header}>
          <Ionicons name="flame" size={20} color="#e74c3c" style={styles.icon} />
      ...
      >
        <View style={styles.header}>
          <Ionicons name="grid" size={20} color="#e74c3c" style={styles.icon} />
      ...
      >
        <View style={styles.header}>
          <Ionicons name="cash" size={20} color="#e74c3c" style={styles.icon} />
      ...
      >
        <View style={styles.header}>
          <Ionicons name="pricetag" size={20} color="#e74c3c" style={styles.icon} />
